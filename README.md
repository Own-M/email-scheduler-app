...
- **Campaign Tags:** Organize outreach with campaign tags available in compose, bulk upload, and dashboard views.
...
- **Bulk Upload with Safety Checks:** CSV/XLSX upload validates account ownership, supports campaign tags, skips suppressed recipients, and avoids near-duplicate scheduling.
- **Dashboard Filtering & CSV Export:** Filter tasks by status/campaign/search and export filtered results as CSV.
